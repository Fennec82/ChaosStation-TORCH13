...
/datum/job/rd
	...
	departments = list(DEPARTMENT_MEDICAL, DEPARTMENT_RESEARCH, DEPARTMENT_COMMAND)
	sorting_order = 2
	...
	access = list(access_rd, access_heads, access_tox, access_genetics, access_morgue,
						...
						access_explorer, access_pathfinder, access_xenobotany, access_medical, access_medical_equip, access_morgue, access_chemistry, access_virology, access_cmo, access_surgery) //YW Edit access_gateway, _explorer, _pathfinder, and _xenobotany //Chaosstation addition - Medical access
	minimal_access = list(access_rd, access_heads, access_tox, access_genetics, access_morgue,
						access_tox_storage, access_teleporter,
						access_research, access_robotics, access_xenobiology, access_ai_upload, access_tech_storage,
						access_RC_announce, access_keycard_auth, access_tcomsat, access_gateway, access_xenoarch, access_eva, access_network,
						access_explorer, access_pathfinder, access_xenobotany, access_medical, access_medical_equip, access_morgue, access_chemistry, access_virology, access_surgery) //YW Edit access_gateway, _explorer, _pathfinder, and _xenobotany //Chaosstation addition - Medical access
	...
	job_description = "The " + JOB_RESEARCH_DIRECTOR + " manages and maintains the MedSci department. They are required to ensure the safety of the entire crew, \
						 and to inform the crew of any disruptions that \
						might originate from MedSci. The " + JOB_RESEARCH_DIRECTOR + " often has at least passing knowledge of most of the Research and Medical departments, but \
...
/datum/job/rd/get_request_reasons()
	return list("Repairs needed", "Medical consult", "Training crew", "Assembling expedition team")
...
/datum/job/scientist
	...
	economic_modifier = 7
	access = list(access_robotics, access_tox, access_tox_storage, access_research, access_xenobiology, access_xenoarch, access_xenobotany, access_medical, access_medical_equip, access_morgue, access_chemistry, access_virology, access_surgery) //Chaosstation addition - Medical access)
	minimal_access = list(access_tox, access_tox_storage, access_research, access_xenoarch, access_medical, access_medical_equip, access_morgue, access_chemistry, access_virology, access_surgery) //Chaosstation addition - Medical access
	...
	job_description = "A " + JOB_SCIENTIST + " is a generalist working in the Research department, with general knowledge of the scientific process, as well as \
						...
						they find an appropriate topic. In an emergency or staffing shortage, they may act as doctors, but surgery is ideally the purview of roboticists."
...
/datum/job/xenobiologist
	...
	selection_color = "#633D63"
	economic_modifier = 7
	access = list(access_robotics, access_tox, access_tox_storage, access_research, access_xenobiology, access_hydroponics, access_medical, access_medical_equip, access_morgue, access_chemistry, access_surgery) //Chaosstation addition - Medical access
	minimal_access = list(access_research, access_xenobiology, access_hydroponics, access_tox_storage, access_medical, access_morgue, access_chemistry, access_surgery) //Chaosstation addition - Medical access
	banned_job_species = list("digital")
	...
	job_description = "A " + JOB_XENOBIOLOGIST + " studies esoteric lifeforms, usually in the relative safety of their lab. They attempt to find ways to benefit \
						from the byproducts of these lifeforms, and their main subject at present is the Giant Slime. They are also responsible for providing medical and surgical care for lesser studied species. \
						A " + JOB_XENOBIOLOGIST + ", and preferably a " + JOB_ALT_XENOANTHROPOLOGIST + " is the ideal candidate to provide medical care to Shadekin, Hanner, and Lleill, and should be deferred to for their care if one is available."
...
/datum/job/xenobiologist/get_request_reasons()
	return list("Medical consult", "Surgical consult")
...
/datum/job/roboticist
	...
	selection_color = "#633D63"
	economic_modifier = 5
	access = list(access_robotics, access_tox, access_tox_storage, access_tech_storage, access_morgue, access_research, access_medical, access_medical_equip, access_morgue, access_chemistry, access_surgery) //As a job that handles so many corpses, it makes sense for them to have morgue access. //Chaosstation addition - Medical access
	minimal_access = list(access_robotics, access_tech_storage, access_morgue, access_research, access_medical, access_medical_equip, access_surgery) //As a job that handles so many corpses, it makes sense for them to have morgue access. //Chaosstation addition - Medical access
	...
	job_description = "A " + JOB_ROBOTICIST + " maintains and repairs the station's synthetics, including crew with prosthetic limbs. \
						They can also assist the station by producing simple robots and even pilotable exosuits. They are expected to provide medical care for full body positronics and cyborgs, as well as repair robots and pAIs. \
						In the event of a staffing shortage or emergency, roboticists are responsible for providing medical and surgical care, and are the perferred choice for performing surgery when a doctor is not available."
	alt_titles = list(
...
/datum/job/roboticist/get_request_reasons()
	return list("Repairs needed", "Surgical consult")
