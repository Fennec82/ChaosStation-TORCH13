...
/datum/robot_sprite/combat/tems
	module_type = "TEMS"
	sprite_icon = 'icons/mob/robot/combat.dmi'

/datum/robot_sprite/combat/tems/default
	name = DEFAULT_ROBOT_SPRITE_NAME
	default_sprite = TRUE
	sprite_icon_state = "default"

/datum/robot_sprite/combat/tems/marina
	name = "Haruka"
	sprite_icon_state = "marina"
	sprite_flags = ROBOT_HAS_SPEED_SPRITE | ROBOT_HAS_SHIELD_SPRITE

/datum/robot_sprite/combat/tems/droid
	name = "Android"
	sprite_icon_state = "droid"
	sprite_flags = ROBOT_HAS_SPEED_SPRITE | ROBOT_HAS_SHIELD_SPRITE

/datum/robot_sprite/combat/tems/droid/get_eyes_overlay(var/mob/living/silicon/robot/ourborg)
	if(ourborg.has_active_type(/obj/item/borg/combat/mobility))
		return
	else
		return ..()

/datum/robot_sprite/combat/tems/insekt
	name = "Insekt"
	sprite_icon_state = "insekt"
	sprite_flags = ROBOT_HAS_SHIELD_SPRITE

/datum/robot_sprite/combat/tems/decapod
	name = "Decapod"
	sprite_icon_state = "decapod"
	has_custom_open_sprites = TRUE
	sprite_flags = ROBOT_HAS_SHIELD_SPRITE

/datum/robot_sprite/combat/tems/mechoid
	name = "Acheron"
	sprite_icon_state = "mechoid"
	sprite_flags = ROBOT_HAS_SPEED_SPRITE | ROBOT_HAS_SHIELD_SPRITE

/datum/robot_sprite/combat/tems/zoomba
	name = "ZOOM-BA"
	sprite_icon_state = "zoomba"
	has_dead_sprite = TRUE
	sprite_flags = ROBOT_HAS_SPEED_SPRITE | ROBOT_HAS_SHIELD_SPRITE

/datum/robot_sprite/combat/tems/worm
	name = "W02M"
...
/datum/robot_sprite/combat/tems/uptall
...
/datum/robot_sprite/dogborg/tall/combat/tems
	module_type = "TEMS"
